...
* Removed window drop shadows
* Added amber 1px border around focused window
* Removed Mint-X related stuff entirely (as it's not the focus of this)

Dependencies for building (unchanged from original):
* optipng
